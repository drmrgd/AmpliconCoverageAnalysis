// html for File Links table container - note these are invisible and moved into position later
document.write('\
...
var columns = [{id: "text", name: "", field: "text", width: 680, resizable : true, formatter: filelink}];

// set up assuming there is no hotspot field - defined when file is loaded
$("#fileLinksTable").css('width','680');
